...
import org.usfirst.frc.team1165.robot.commands.ToggleAgitator;
import org.usfirst.frc.team1165.robot.commands.TogglePickup;
...
public class OI
{
	...
	JoystickButton shooterRPMButton = new JoystickButton(stick, RobotMap.shooterRPMPortNumber);//9
	...
	JoystickButton agitatorToggle = new JoystickButton(stick, 7);

	//JoystickButton servoButton = new JoystickButton(stick, RobotMap.rightServoButtonNumber);//11
	
	JoystickButton pickupToggle = new JoystickButton(stick, 11);
	...
	public OI()
	{
		...
		pickupToggle.whenPressed(new TogglePickup());;
		...
		agitatorToggle.whenPressed(new ToggleAgitator());
